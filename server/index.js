...
function buildRecommendations(p, issues) {
  ...
  for (const t of (p.earlyOverload || [])) {
    const cause = t.tight
      ? `ранние уроки (1–4) заняты у него полностью: ${t.earlyLessons} уроков при ёмкости ${t.earlyCapacity} — впритык, любой другой ранний урок вытеснит математику/русский`
      : `ранних уроков (1–4) нужно ${t.earlyLessons}, а помещается только ${t.earlyCapacity} — не влезает ${t.deficit}`;
    recs.push(`${t.teacher}: ${cause}. Математика/русский в 5–6 классах разрешены только на 1–4 урок, и один учитель не может вести два класса одновременно. Решение (любое): добавьте второго учителя математики/русского для части этих классов, ИЛИ уменьшите ему число 5–6 классов, ИЛИ отключите правило «только 1–4 урок» (Ограничения → Правила составления).`);
  }
